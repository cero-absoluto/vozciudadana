  ...
  <div class="screen active" id="s-api">
    <div class="scroll" style="padding:16px">
      ...
      <div style="margin-bottom:20px">
        <div style="font-size:9px;color:var(--text3);text-transform:uppercase;letter-spacing:1px;margin-bottom:6px">{{ $t('api.openData') }}</div>
        ...
        <div style="font-size:12px;color:var(--text2);line-height:1.7">{{ $t('api.desc') }}</div>
      ...
      <div class="api-block">
        ...
        <div style="font-size:12px;color:var(--text2)">{{ $t('api.rateLimitDesc') }}</div>
      </div>
      ...
      <div class="api-block">
        ...
        <div style="font-size:12px;color:var(--text2);margin-bottom:10px">{{ $t('api.endpoint1Desc') }}</div>
      ...
      <div class="api-block">
        ...
        <div style="font-size:12px;color:var(--text2);margin-bottom:6px">{{ $t('api.endpoint2Desc') }}</div>
      ...
      <div class="api-block">
        ...
        <div style="font-size:12px;color:var(--text2);margin-bottom:10px">{{ $t('api.endpoint3Desc') }}</div>
