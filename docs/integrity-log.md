...
| Version | Description |
|---------|-------------|
| v1 | Internal integrity seal (HMAC-SHA256). Not fully publicly reproducible without server secret. |
...
3. Build city distribution string: `city1:count1,city2:count2,...` (sorted by city name)
4. Build reliability string: `score1:count1,score2:count2,...` (sorted by score)
...
6. Calculate `SHA256` of that string
7. Compare with `integrity_hash` in this log
...
*This log is updated manually when a protest closes. Each entry is a permanent Git commit.*
*Source code: [github.com/cero-absoluto/vozciudadana](https://github.com/cero-absoluto/vozciudadana) — AGPL 3.0*
